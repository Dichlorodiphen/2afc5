...
if firmSandOrder == 1:
	lookEnvironment = viz.addAudio(ABC_dir + '/AudioInstructions/lookEnvironmentSandRight.mp3')
...
#firmSandOrder = viz.input('Is the sand to the right: 1 for yes, 0 for no','')
	...
	poleSpots[2][0] = 1.0
	poleSpots[3][0] = -1.0
	lookEnvironment = viz.addAudio(ABC_dir + '/AudioInstructions/lookEnvironmentSandLeft.mp3')
#	poleSpots[2][1] = -1.0
#	poleSpots[3][1] = 1.0
	# 100 X 0 X 200
	concrete.setPosition(100, 0.148, 0)
